...
- Pour les tokens d'exchanges : Analyse le modèle exact de la plateforme hôte (CEX classique, DEX, UEX, fonctions de burn, réduction de frais, staking, launchpad). Ne colle PAS d'étiquette générique si l'entreprise n'a pas officiellement opéré ce changement.
